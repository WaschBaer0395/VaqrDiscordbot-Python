...
class ModLog(commands.Cog):
    ...
    async def on_invite_create(self, invite):
        ...
        embed = discord.Embed(colour=discord.Color.blue(),
                              description=f"**Invite created in {invite.channel.mention} with an ID of **{invite.id}**. [Invite link]({invite.url})**")
    ...
    async def on_invite_delete(self, invite):
        ...
        embed.set_author(name="Invite Deleted", icon_url=invite.guild.icon_url if invite.guild.icon != None else '')
